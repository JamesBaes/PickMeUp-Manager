...
const adminPageLinks = [
  { page: "Dashboard", route: "/staff", icon: LayoutDashboard },
  { page: "Live Orders", route: "/staff/live-orders", icon: Zap },
  { page: "Order History", route: "/staff/order-history", icon: History },
  { page: "Menu", route: "/staff/menu", icon: UtensilsCrossed },
]
